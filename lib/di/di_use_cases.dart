...
import 'package:surf_flutter_study_jam_2023/features/ticket_storage/domain/use_cases/ticket_use_cases/put_all_tickets_use_case.dart';
...
import 'package:surf_flutter_study_jam_2023/features/ticket_storage/domain/use_cases/ticket_use_cases/update_ticket_use_case.dart';
...
void setupUseCases() {
  ...
  _getIt.registerLazySingleton<PutAllTickets>(() => PutAllTickets(
        ticketRepository: _getIt(),
      ));

  _getIt.registerLazySingleton<UpdateTicket>(() => UpdateTicket(
    ticketRepository: _getIt(),
  ));
}
